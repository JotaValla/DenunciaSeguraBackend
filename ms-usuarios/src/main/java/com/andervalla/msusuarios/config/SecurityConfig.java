...
public class SecurityConfig {
    ...
    /**
     * URL pública del emisor (claim {@code iss}) que debe coincidir al validar el
     * token.
     */
    ...
    /**
     * Cadena principal que protege el resto de endpoints como recurso OAuth2 con
     * JWT.
     */
    @Bean
    @Order(1)
    ...
    /**
     * Ajusta el convertidor para mapear claims a autoridades y añadir el rol
     * personalizado.
     */
